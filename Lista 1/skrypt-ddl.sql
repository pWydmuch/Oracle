...
CREATE TABLE Bandy
( nr_bandy NUMBER(2) CONSTRAINT bn_pk PRIMARY KEY,
nazwa VARCHAR2(20) CONSTRAINT bn_nz_nn NOT NULL,
teren VARCHAR2(15) CONSTRAINT bn_tr_uq UNIQUE,
szef_bandy VARCHAR2(15) CONSTRAINT bn_sb_uq UNIQUE
);

CREATE TABLE Funkcje 
( funkcja VARCHAR2(10) CONSTRAINT fn_pk PRIMARY KEY,
  min_myszy NUMBER(3) CONSTRAINT fn_min_ch CHECK(min_myszy > 5),
  max_myszy NUMBER(3) CONSTRAINT fn_max_ch CHECK(max_myszy <200),
  CONSTRAINT fn_max_min_ch CHECK(max_myszy>=min_myszy)
);
--
...
--
CREATE TABLE Kocury 
(pseudo VARCHAR2(15) CONSTRAINT kc_pk PRIMARY KEY,
imie VARCHAR2(15) CONSTRAINT kc_im_nn NOT NULL,
plec VARCHAR2(1) CONSTRAINT kc_pl_ch CHECK(plec IN('M','D')),
funkcja VARCHAR2(10) CONSTRAINT kc_fn_fk REFERENCES Funkcje(funkcja),
szef VARCHAR2(15) CONSTRAINT kc_sz_fk REFERENCES Kocury(pseudo) DEFERRABLE INITIALLY DEFERRED,
w_stadku_od DATE DEFAULT SYSDATE,
przydzial_myszy NUMBER(3),
myszy_extra NUMBER(3),
nr_bandy NUMBER(2) CONSTRAINT kc_nrb_fk REFERENCES Bandy(nr_bandy)
);
--
ALTER TABLE Bandy
    ADD CONSTRAINT bn_fk 
